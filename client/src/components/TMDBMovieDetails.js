...
function TMDBMovieDetails({ close_modal, movie_details, movie_credits, handleSlateMovie }) {
    ...
    return (
        <div className="lg:w-5/6 md:w-5/6 bg-neutral-700 rounded-lg p-8 md:mx-auto w-full mt-10">
            <div className="w-full flex justify-end">
                <button onClick={close_modal} style={{ fontFamily: 'Viga-Regular' }} className="text-white bg-red-700 uppercase border-0 px-2 focus:outline-none hover:bg-red-800 rounded text-lg -mr-4 -mt-4">X</button>
            </div>
            <div className="grid grid-cols-3">
                <div className="h-auto mr-4 flex flex-col">
                    <img src={movie_details.poster_path ? `https://image.tmdb.org/t/p/w600_and_h900_bestv2${poster_path}` : "https://www.themoviedb.org/assets/2/v4/glyphicons/basic/glyphicons-basic-38-picture-grey-c2ebdbb057f2a7614185931650f8cee23fa137b93812ccb132b9df511df1cfac.svg"} className="w-full" />
                    <button id={movie_details.id} onClick={(e) => slateMovie(e, movie_details)} style={{ fontFamily: 'Viga-Regular' }} className="mt-5 mx-auto text-white bg-sky-700 uppercase border-0 py-2 px-8 focus:outline-none hover:bg-sky-800 rounded text-lg">Add to Slate</button>
                </div>
                <div className="col-span-2 flex flex-col justify-between">
                    <div className="flex flex-col justify-between">
                        ...
                        {/* <div className="flex flex-wrap mb-2"><p>Starring</p>{movie_cast}</div> */}
